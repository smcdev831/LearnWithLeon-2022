...
class Bird extends Animal {
  ...
  fly() {
    if (this._canFly)
      console.log(
        `look at me, i'm FLYING and my wingspan is ${this._wingspan}. all hail me`
      );
    else
  ...
  speak() {
    console.log(
      `i'm a bird, look at my wings. i've got a wingspan of ${
        this._wingspan
      }, i ${this._isMigratory ? "do" : "don't"} migrate`
    );
  }
}
...
class Mammal extends Animal {
  ...
  givingBirth() {
    if (this._liveBirth)
      ...
      console.log(
        " lay eggs cause I ain't raising that baby inside of me so Im not a Mammal"
      );
  }
}
